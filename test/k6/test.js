...
// handleSummary grava em caminho relativo ao CWD do processo (onde você rodou o k6), não à pasta do script.
// Ex.: na raiz do repo: k6 run -e K6_RESULTS=test/results.json test/k6/test.js
// Padrão results.json → arquivo no diretório atual (evita "caminho não encontrado").
const summaryOutputPath = __ENV.K6_RESULTS || "results.json";
...
export function handleSummary(data) {
    ...
    return {
        [summaryOutputPath]: JSON.stringify(result, null, 2),
